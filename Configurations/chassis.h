...
/* PID参数定义 */
/* 四个电机的速度环PID */
#define CONFIG_PID_CHASSIS_RF_P 3
#define CONFIG_PID_CHASSIS_RF_I 1
#define CONFIG_PID_CHASSIS_RF_D 0
#define CONFIG_PID_CHASSIS_RF_MAX_OUTPUT 7000
#define CONFIG_PID_CHASSIS_RF_INTERGRAL_LIMIT 3000

#define CONFIG_PID_CHASSIS_LF_P 3
#define CONFIG_PID_CHASSIS_LF_I 1
#define CONFIG_PID_CHASSIS_LF_D 0
#define CONFIG_PID_CHASSIS_LF_MAX_OUTPUT 7000
#define CONFIG_PID_CHASSIS_LF_INTERGRAL_LIMIT 3000

#define CONFIG_PID_CHASSIS_LB_P 3
#define CONFIG_PID_CHASSIS_LB_I 1
#define CONFIG_PID_CHASSIS_LB_D 0
#define CONFIG_PID_CHASSIS_LB_MAX_OUTPUT 7000
#define CONFIG_PID_CHASSIS_LB_INTERGRAL_LIMIT 3000

#define CONFIG_PID_CHASSIS_RB_P 3
#define CONFIG_PID_CHASSIS_RB_I 1
#define CONFIG_PID_CHASSIS_RB_D 0
#define CONFIG_PID_CHASSIS_RB_MAX_OUTPUT 7000
#define CONFIG_PID_CHASSIS_RB_INTERGRAL_LIMIT 3000
