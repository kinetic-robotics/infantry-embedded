...
/* 底盘功率环PID */
#define CONFIG_PID_CHASSIS_POWER_LIMIT_P 0.1
#define CONFIG_PID_CHASSIS_POWER_LIMIT_I 0
#define CONFIG_PID_CHASSIS_POWER_LIMIT_D 0
#define CONFIG_PID_CHASSIS_POWER_LIMIT_MAX_OUTPUT 1
#define CONFIG_PID_CHASSIS_POWER_LIMIT_INTERGRAL_LIMIT 0

/* 电容模块离线时的功率系数 */
#define CONFIG_CHASSIS_POWER_LIMIT_LEVEL_DEFAULT    0.4

/* 电容模块默认功率 */
#define CONFIG_CHASSIS_CAPACITY_POWER_DEFAULT       40
